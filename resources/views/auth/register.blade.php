            ...
            <form action="" method="POST" novalidate>
                <div class="mb-5">
                    ...
                    <input id="name" name="name" type="text" placeholder="Tu Nombre"
                        class="border p-3 w-full rounded-lg @error('name') border-red-500 @enderror" value="" />
                </div>
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <input id="email" name="email" type="email" placeholder="Tu Email de Registro"
                        class="border p-3 w-full rounded-lg @error('email') border-red-500 @enderror" value="" />
                </div>
                <div class="mb-5">
